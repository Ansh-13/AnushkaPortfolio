...
export default function Projects() {
  ...
  return (
    <div className="h-screen w-full overflow-y-auto bg-[#f6ccde]">
          ...
          <AnimatePresence custom={direction} initial={false} mode="popLayout">
            ...
            >
              ...
              >
                {/* Static solid border */}
                <span
                  className={`absolute inset-0 border-2 border-solid border-purple-100 rounded-lg transition-all duration-300 ${
